...
class FeedForwardNetwork(object):
    ...
    def create(genome):
        ...
        layers = feed_forward_layers(genome.config.input_keys, genome.config.output_keys, connections)
        node_evals = []
        for layer in layers:
            for node in layer:
                inputs = []
        ...
        return FeedForwardNetwork(genome.config.input_keys, genome.config.output_keys, node_evals)
